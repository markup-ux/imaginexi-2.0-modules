...
UPDATE `spell_list` SET `jobs` = 0x000000040B00000400000000000000000000000D0016 WHERE `spellid` = 249; -- blaze_spikes
UPDATE `spell_list` SET `jobs` = 0x000000091500000A000000000000000000000019001F WHERE `spellid` = 250; -- ice_spikes
UPDATE `spell_list` SET `jobs` = 0x0000000F1D00000E000000000000000000000022001F WHERE `spellid` = 251; -- shock_spikes
...
UPDATE `spell_list` SET `jobs` = 0x00000000000000060000000000000000000000000000 WHERE `spellid` = 277; -- dread_spikes
